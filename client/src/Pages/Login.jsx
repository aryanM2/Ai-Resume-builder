    ...
    return (
        <>
            <SEO
                ...
                description="Sign in to your ResumeAI account to manage your resumes and continue building your professional career."
                keywords="login, sign in, resume builder login, account access"
            ...
            <div className="flex items-center justify-center min-h-screen bg-gray-50 w-full">
                <form onSubmit={handleSubmit} className="bg-white text-gray-500 max-w-[340px] w-full mx-4 md:p-6 p-4 py-8 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div><Link to="/forgot-password" className="text-blue-600 underline">Forgot Password</Link></div>
                    </div>
                    ...
                    <button
                        type="button"
                        onClick={() => window.location.href = `${import.meta.env.VITE_API_URL}/api/users/google`}
